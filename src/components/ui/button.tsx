...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // Primary CTA: solid deep blue
        default: "bg-primary text-primary-foreground hover:bg-primary/90",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        // Secondary CTA: grey outline
        outline: "border border-muted-foreground/30 bg-transparent text-muted-foreground hover:bg-secondary hover:text-foreground",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-secondary hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        // Audit-grade primary hero button
        hero: "bg-primary text-primary-foreground font-medium hover:bg-primary/90",
        // Audit-grade secondary outline button
        "hero-outline": "bg-transparent border border-muted-foreground/30 text-muted-foreground font-medium hover:bg-secondary hover:text-foreground",
      },
      size: {
